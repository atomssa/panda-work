...
// This Class's Header --
//-----------------------
#include "PndPidBremCorrectorSaveMCT.h"
...
PndPidBremCorrectorSaveMCT::PndPidBremCorrectorSaveMCT():
...
InitStatus PndPidBremCorrectorSaveMCT::Init() {

  // Get RootManager
  FairRootManager* ioman = FairRootManager::Instance();
  if ( ! ioman ){
    cout << "-E- PndPidBremCorrectorSaveMCT::Init: "
...
void PndPidBremCorrectorSaveMCT::Exec(Option_t* opt)
{
...
PndPidBremCorrected4Mom* PndPidBremCorrectorSaveMCT::AddBremCorrected4Mom(){
  TClonesArray& clref = *fBremCorrected4MomArray;
  Int_t size = clref.GetEntriesFast();
  return new(clref[size]) PndPidBremCorrected4Mom();
}

double PndPidBremCorrectorSaveMCT::GetSepPhotonE(PndPidCandidate *ChargedCand, std::vector<int>& sep_bumps){
...
double PndPidBremCorrectorSaveMCT::GetMergPhotonE(PndPidCandidate *ChargedCand, std::vector<int>& phi_bumps){
...
void PndPidBremCorrectorSaveMCT::GetEmcPhiBumpList(int iClust) {
