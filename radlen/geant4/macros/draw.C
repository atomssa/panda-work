...
draw() {
  ...
  int ndet = 20;
  TFile* fin = TFile::Open("test_1M_evt.root");
  ...
  tl->Draw();
  tc_stt_mvd_pipe->Print("stt_mvd_pipe.png");
  ...
  tl->Draw();
  tc_stt_mvd_gem_pipe->Print("stt_mvd_gem_pipe.png");
