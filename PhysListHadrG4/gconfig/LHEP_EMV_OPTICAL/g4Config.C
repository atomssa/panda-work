...
void Config()
{
  ...
  cout << "$$$$LocalErmias$ Geant4 VirtualMC configuration macro" << endl;
  ...
  /// - XYZ                - selected hadron physics list ( XYZ = LHEP_EMV+optical, QGSP, ...)
  ...
  TG4RunConfiguration* runConfiguration 
    = new TG4RunConfiguration("geomRoot", "LHEP_EMV+optical", "stepLimiter+specialCuts+specialControls");
  ...
  cout << "$$$$LocalErmias$ Geant4 VirtualMC configuration macro done~!!" << endl;
