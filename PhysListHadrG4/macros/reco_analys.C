{
  ...
  TFile* f = new TFile("output/data_QGS_BERT_EMV_MOM_1.0_pim.root"); //file you want to analyse
  ...
  TH1F *h2= new TH1F("h2","Phi difference",200,-25.,25.);
  TH1F *h3= new TH1F("h3","Cluster energy",100,0.0,1.05);
  TH2F *h2theta= new TH2F("h2theta","Theta difference",200,0.,180.,200,-5.,5.);
  TH2F *h2phi= new TH2F("h2phi","Phi difference",200,0.,180.,200,-25.,25.);
