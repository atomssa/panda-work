...
void fig_ana2() {
  ...
  for (int iplab=0; iplab<nplab; ++iplab) {
	...
	if (pol3) {
	  ...
	  fmbg_tu[itu][iplab][itbin] = new TF1(Form("fmep_bg_p%d_%s%db",iplab,toru[itu],itbin),background3,2.3,3.8,4);
	  fmsg_tu[itu][iplab][itbin] = new TF1(Form("fmep_sg_p%d_%s%db",iplab,toru[itu],itbin),gaussianPeak,2.3,3.8,3);
	} else {
	  ...
	  fmbg_tu[itu][iplab][itbin] = new TF1(Form("fmep_bg_p%d_%s%db",iplab,toru[itu],itbin),background2,2.3,3.8,3);
	  fmsg_tu[itu][iplab][itbin] = new TF1(Form("fmep_sg_p%d_%s%db",iplab,toru[itu],itbin),gaussianPeak,2.3,3.8,3);
	}
	...
	if (true) {
	  ...
	  //for (int ipar=pol3?4:3; ipar<pol3?7:6; ++ipar) fmbg_tu[itu][iplab][itbin]->SetParameter(ipar-(pol3?4:3), fmfg_tu[itu][iplab][itbin]->GetParameter(ipar));
	} else {
