...
void fig_num_evt() {
  ...
  tcsig->Print(Form("figs/2015.06.08/%s.pdf", tcsig->GetName()));
  ...
  tcbg->Print(Form("figs/2015.06.08/%s.pdf", tcbg->GetName()));
...
void fig_kin_cuts() {
  ...
  tc1->Print(Form("figs/2015.06.08/%s.pdf",tc1->GetName()));
...
void fig_npair() {
  ...
  sig_s0_s1->Print("figs/2015.06.08/num_ep_pair_vs_cut_sig.pdf");
  sig_s0_s1_noarrow->Print("figs/2015.06.08/num_ep_pair_vs_cut_sig_noarrow.pdf");
}
...
void fig_pi0cut() {
  ...
  for (int iplab=0; iplab<nplab; ++iplab) {
    ...
    if (bidims) {
      ...
      tc_sig_avg[iplab]->Print(Form("figs/2015.06.08/pi0cut_%s.png",tc_sig_avg[iplab]->GetName()));
      gSystem->Exec(Form("convert figs/2015.06.08/pi0cut_%s.png figs/2015.06.08/pi0cut_%s.pdf", tc_sig_avg[iplab]->GetName(), tc_sig_avg[iplab]->GetName()));
      ...
      tc_bg_avg[iplab]->Print(Form("figs/2015.06.08/pi0cut_%s.png",tc_bg_avg[iplab]->GetName()));
      gSystem->Exec(Form("convert figs/2015.06.08/pi0cut_%s.png figs/2015.06.08/pi0cut_%s.pdf", tc_bg_avg[iplab]->GetName(), tc_bg_avg[iplab]->GetName()));
  ...
  tc_sig_minv_allplab->Print(Form("figs/2015.06.08/pi0cut_%s.pdf",tc_sig_minv_allplab->GetName()));
  tc_bg_minv_allplab->Print(Form("figs/2015.06.08/pi0cut_%s.pdf",tc_bg_minv_allplab->GetName()));
...
void fig_gen_dists() {
  ...
  tc_gen_t_sig->Print(Form("figs/2015.06.08/%s.pdf", tc_gen_t_sig->GetName()));
  tc_gen_t_bg->Print(Form("figs/2015.06.08/%s.pdf", tc_gen_t_bg->GetName()));
  ...
  tc_gen_cthcm_sig->Print(Form("figs/2015.06.08/%s.pdf", tc_gen_cthcm_sig->GetName()));
  tc_gen_cthcm_bg->Print(Form("figs/2015.06.08/%s.pdf", tc_gen_cthcm_bg->GetName()));
  ...
  tc_gen_thlab_sig->Print(Form("figs/2015.06.08/%s.pdf", tc_gen_thlab_sig->GetName()));
  tc_gen_thlab_bg->Print(Form("figs/2015.06.08/%s.pdf", tc_gen_thlab_bg->GetName()));
  ...
  tc_gen_t_sig2->Print(Form("figs/2015.06.08/%s.pdf", tc_gen_t_sig2->GetName()));
  tc_gen_t_bg2->Print(Form("figs/2015.06.08/%s.pdf", tc_gen_t_bg2->GetName()));
...
void fig_ana() {
  ...
  for (int iplab=0; iplab<nplab; ++iplab) {
    ...
    for (int istep=0; istep<nstep; ++istep) {
      ...
      tc_mep_steps[iplab][istep]->Print(Form("figs/2015.06.08/%s.pdf",tc_mep_steps[iplab][istep]->GetName()));
    }
    tc_mep_all_steps[iplab]->Print(Form("figs/2015.06.08/%s.pdf",tc_mep_all_steps[iplab]->GetName()));

    tmg_yield[iplab] = new TMultiGraph(Form("tmg_yield_p%d",iplab),Form("tmg_yield_p%d",iplab));
    tg_sig_yield[iplab] = new TGraph(nstep,x,yield_sig[iplab]);
    ...
    tg_bg_yield[iplab] = new TGraph(nstep,x,yield_bg[iplab]);
    ...
    tg_sig_eff[iplab] = new TGraph(nstep,x,eff_sig[iplab]);
    ...
    tg_bg_eff[iplab] = new TGraph(nstep,x,eff_bg[iplab]);
    ...
    tg_stob[iplab] = new TGraph(nstep,x,stob[iplab]);
  ...
  yield_step->Print("figs/2015.06.08/yield_vs_steps.pdf");
  ...
  eff_step->Print("figs/2015.06.08/eff_vs_steps.pdf");
  ...
  stob_step->Print("figs/2015.06.08/stob_vs_steps.pdf");
}
...
void fig_ana2() {
  ...
  for (int iplab=0; iplab<nplab; ++iplab) {
	...
	//tline->DrawLine(mmax,0,mmax,0.75*hmfg_tu[itu][iplab][itbin]->GetMaximum());
      ...
      tc_mep_tbins[itu][iplab]->Print(Form("figs/2015.06.08/%s.pdf",tc_mep_tbins[itu][iplab]->GetName()));
  ...
  for (int itu = 0; itu < 1; ++itu) {
    ...
    tc_yield_pbp[itu]->Print(Form("figs/2015.06.08/%s.pdf",tc_yield_pbp[itu]->GetName()));
    ...
    tc_yield_cnt_pbp[itu]->Print(Form("figs/2015.06.08/%s.pdf",tc_yield_cnt_pbp[itu]->GetName()));
    //tc_yield_cnt_pbp[itu] = new TCanvas(Form("fitted_yield_cnt_pbp%s",toru[itu]),Form("fitted_yield_cnt_pbp%s",toru[itu]));
    //tc_yield_cnt_pbp[itu]->Divide(3,1);
    //for (int iplab = 0; iplab < nplab; ++iplab) {
    ...
    tc_prob[itu]->cd();
    tmg_prob[itu]->Draw("a");
    tc_yield[itu]->Print(Form("figs/2015.06.08/%s.pdf",tc_yield[itu]->GetName()));
  }
...
void fig_tvsthcm_sig() {
  ...
  tc[3]->Update();
  tc[3]->Print((Form("figs/2015.06.08/validity_iplab3.png")));
  gSystem->Exec(Form("convert figs/2015.06.08/validity_iplab3.png figs/2015.06.08/validity_iplab3.pdf"));
  ...
  for (int iplab=0; iplab<nplab; ++iplab) {
    ...
    tc[iplab]->Print(Form("figs/2015.06.08/validity_iplab%d.png",iplab));
    gSystem->Exec(Form("convert figs/2015.06.08/validity_iplab%d.png figs/2015.06.08/validity_iplab%d.pdf", iplab, iplab));
  }
