...
def generate():
    ...
    # run file_names with dummy tag just to log start time
    (dummy1,dummy2,dummy3) = my_utils.file_names("timer")
    (dummy,filt_out,dummy) = my_utils.file_names("filt") # 
    
    if not os.path.exists(filt_out):
        run_dpm()
